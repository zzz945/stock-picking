<template>
  <div class="button-demo">
    ...
    <checklist title="set required=false and no min-error will show" :options="commonList" :value.sync="checklist004" :max=2
      :required=false @on-change="change"></checklist>
    ...
    <checklist title="Option Array with key and value(key must be string)" :options="objectList" :value.sync="objectListValue"
